...
public class FileAppend extends AbstractConnector implements Connector {
    ...
    public void connect(MessageContext messageContext) {
        ...
        String ftpOverHttp = (String) ConnectorUtils.lookupTemplateParamater(messageContext,
                FileConstants.FTP_OVER_HTTP);
        boolean resultStatus = appendFile(destination, content, encoding,ftpOverHttp,
                messageContext);
    ...
    private boolean appendFile(String destination, String content,
                               String encoding,String ftpOverHttp, MessageContext messageContext) {
        ...
        try {
            ...
            if(ftpOverHttp.equals("true")) {
                FileConnectorUtils.ftpOverHttp(messageContext);
                fileObj = manager.resolveFile(destination);
            } else{
